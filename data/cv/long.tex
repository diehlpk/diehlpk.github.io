...
\item Efficient, performance portable, and scalable High-Performance Parallel Programming using Modern C++.
\end{itemize}
\cvitem{Open science}{}
\begin{itemize}[leftmargin=4cm]
...
\cvitem{NSF REU}{}
\begin{itemize}[leftmargin=4cm]
\item Louisiana State University: A. Edwards (2021) and E. Downing (2022)
\end{itemize}
...
\cvitem{10/21--current}{Reviewer for Mathematical Reviews\textsuperscript{\textregistered} (MathSciNet\textsuperscript{\textregistered})}
\cvitem{07/21--current}{Member-at-Large of the USACM Technical Thrust Area (TTA) on Large Scale Structural Systems and Optimal Design (Large-Scale)}
...
\item Workshop on Workshop on Asynchronous Many-Task Systems and Applications 2023,  \href{https://wamta23.stellar-group.org/}{Link}
