...
\address{Los Alamos National Laboratory}{Los Alamos, NM 87545, USA}{}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\phone[fixed]{+1~(505)~500~9948}
%\phone[fax]{+49~(228)~73~3979}
\email{diehlpk@lanl.gov}    
...
\usepackage{multibib}
\newcites{review,proceedings,talk,poster,thesis,journal,spapers,reports,pre,exp,booksedited,books}{{\underline{Reviews and Surveys}},{\underline{Series- and conference contributions}},{},{\underline{Posters}},{},{\underline{Journal Papers}},{\underline{Short papers}},{\underline{Technical reports}},{\underline{Preprints}},{},{\underline{Edited books}},{\underline{Books}}}
...
\cventry{Oct 2025--Oct 2026}{Research scientist}{Computing and Artificial Intelligence (CAI-1)}{Los Alamos National Laboratory}{Los Alamos, NM, USA}{}
\cventry{May 2022--Aug 2026}{Adjunct faculty}{Department of Physics \& Astronomy}{Louisiana State University}{Baton Rouge, LA, USA}{}
\cventry{Jun 2024--Sep 2025}{Research scientist}{Applied Computer Science (CCS-7)}{Los Alamos National Laboratory}{Los Alamos, NM, USA}{}
\cventry{Oct 2018--Jun 2024}{Research scientist}{Center for Computation \& Technology}{Louisiana State University}{Baton Rouge, LA, USA}{}
\cventry{Feb 2017--Sep 2018}{Postdoctoral fellow}{Laboratory of Multiscale Mechanics}{Polytechnique Montr\'eal}{QC, Canada}{}
\cventry{Apr 2013--Jan 2017}{Research Assistant}{Institute for Numerical Simualtions}{University of Bonn}{Bonn, Germany}{}
\cventry{Jul 2012--Mar 2013}{Research Assistant}{Institute for Simulation of large Systems}{University of Stuttgart}{Stuttgart, Germany}{}
\cventry{Oct 2007---Jun 2012}{Student}{Computer Science (Major software engineering)}{University Stuttgart}{Stuttgart, Germany}{}
\section{Board Memberships \& Governance}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{Oct 2025---current}{Event coordinator}{Bradbury Science Museum Association}{}{Los Alamos, NM, USA}{}
\cventry{July 2024---current}{Member}{High Performance ParalleX (HPX) Project Management Committee (PMC)}{}{}{}
...
\section{Education}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{January 2017}{PhD}{Applied mathematics}{University of Bonn}{Germany}{}
\cventry{August 2012}{Diploma}{Computer Science}{University of Stuttgart}{Germany}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\cventry{2025}{Topical issue editor}{Recent advances in Asynchronous Many Task Runtime Systems, SN Computer Science}{}{}{}
\cventry{2025}{Guest editor}{Research Software Engineering – Code, Practices, and People, Future Generation Computer Systems}{}{}{}
\cventry{2024}{Guest editor}{Research Software Engineering – Software-Enabled Discovery and Beyond, Future Generation Computer Systems}{}{}{}
...
\cvitem{NSF Research Experiences for Undergraduates}{}
\begin{itemize}[leftmargin=4cm]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cvitem{08/25--current}{Chair  of the USACM Technical Thrust Area (TTA) on Large Scale Structural Systems and Optimal Design (Large-Scale)}
...
\cvitem{03/20--12/23}{Liaison for the Louisiana district of the SIAM Texas-Louisiana Section\linebreak
Duties:}
\begin{itemize}[leftmargin=4cm]
...
\cvitem{Committee}{}
\begin{itemize}[leftmargin=4cm]
\item 3rd Annual Conference of the US Research Software Engineer Association, Publication chair
\item The 1st International Workshop on Agentic AI for HPC co-located with SC 26, Program Committee 
\item Programming Frameworks, Technical Papers for SC25, Member
\item ChapelCon '25, Program Committee 
\item AI track of 54th International Conference on Parallel Processing, Program 
...
\cvitem{Panel}{}
\begin{itemize}[leftmargin=4cm]
\item The Future of the HPC Workforce: Skills, Scale, and Sustainability, International Conference for High Performance Computing, Networking, Storage and Analysis (SC) 2026
...
\item TBAA: Task-Based Algorithms and Applications, International Conference for High Performance Computing, Networking, Storage and Analysis (SC) 2020 \href{https://stellar-group.org/research/tbaa2020-scpanel/}{Link}
...
\cvitem{Tutorial}{}
\begin{itemize}[leftmargin=4cm]
\item A tutorial for Kokkos: Performance Portability for C\texttt{++} Applications and Libraries,  International Conference for High Performance Computing, Networking, Storage and Analysis (SC) 2026
\item HPX Tutorial Session: Advanced Parallel Programming in C\texttt{++} using HPX, High Performance Software Foundation (HPSF) 2026
\end{itemize}

\cvitem{Mentoring events}{}
\begin{itemize}[leftmargin=4cm]
\item 18th U.S. National Congress on Computational Mechanics, 2025
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cvitem{2023}{SIAM Travel Award  - 10th International Congress on Industrial and Applied Mathematics (ICIAM) (\$1750)}
...
\item Grant \#4000211901 (Hartmut Kaiser)
\begin{description}
\item Name of Funding Organization:  UT-Battelle, LLC
\item Amount Awarded: \$9,999
\item Period of Grant Award: July 15 2022 - April 30 2024
\item Title of Project:  S4PST, Sustainability for Node Level Programming Systems and Tools
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../list/books}
\bibliographystylebooks{../list/habbrvyr}
\bibliographybooks{../list/publications}   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../list/reviews}
\bibliographystylereview{../list/habbrvyr}
\bibliographyreview{../list/publications} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../list/journal}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../list/posters}
\bibliographystyleposter{../list/habbrvyr}
\bibliographyposter{../list/publications}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Thesis}
...
\section{Reviewer}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cvitem{}{Computational Particle Mechanics, PLOS ONE, International Journal of Mechanical Sciences, Fatigue \& Fracture of Engineering Materials \& Structures, Computer Physics Communications, International Journal of Fracture, Parallel Computing, International Journal of High Performance Computing Applications, Computer Methods in Applied Mechanics and Engineering, Theoretical and Applied Fracture Mechanics,   Mathematics and Mechanics of Solids,  Journal of Engineering Mechanics, Computational Mechanics,  Mathematical Reviews,  Engineering with Computers,  Computer Modeling in Engineering \& Sciences (CMES),  Journal of Peridynamics and Nonlocal Modeling,  Engineering Analysis with Boundary Elements, Computers in Biology and Medicine, and Concurrency and Computation: Practice and Experience.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
