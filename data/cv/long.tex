...
\item Prof.~Marc~Alexander~Schweitzer, Institute for Numerical Simulation, University of Bonn, Germany, E-Mail: schweitzer@ins.uni-bonn.de
\item Prof.~Daniel~Peterseim, Numerische Mathematik, University of Augsburg, Germany, E-Mail: daniel.peterseim@math.uni-augsburg.de
\end{itemize}}
\cvitem{Postdoctoral fellow advisers}{\begin{itemize}
\item Prof.~Martin~L\'evesque, Department of Mechanical Engineering, Polytechnique Montr\'eal, Canada, E-Mail: martin.levesque@polymtl.ca
\item Prof.~Serge~Prudhomme, Department of Mathematical and Industrial Engineering,Polytechnique Montr\'eal, Canada, E-Mail: serge.prudhomme@polymtl.ca
\end{itemize}}
\cvitem{Collaborators}{\begin{itemize}
\item Prof.~Robert~Lipton, Mathematics of Materials Science, Louisiana State University, USA, E-Mail: lipton@math.lsu.edu
\item Prof.~Thomas~Ertl, Visualization and Interactive Systems Institute, University of Stuttgart, Germany, E-Mail: thomas.ertl@vis.uni-stuttgart.de
\end{itemize}}
